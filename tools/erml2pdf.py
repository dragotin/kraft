...
def erml2pdf_help():
        ...
        Tool to render a file of the xml based markup language RML to PDF
        with option to merge another PDF file as watermark.
        
        Options:
        -o, --output <file>           output file, instead of standard out
        -m, --watermark-mode <mode>   set the watermark mode with
                                      0 = no watermark (default)
                                      1 = watermark on first page
                                      2 = watermark on all pages
                                      Note: a watermark file must be specified for 1, 2
        -w, --watermark-file <file>   watermark file, the first page is used.
        ''') 
        sys.exit(0)
