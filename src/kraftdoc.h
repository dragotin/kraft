...
// forward declaration of the Kange classes
...
/**	KraftDoc provides a document object for a document-view model.
  *
  * The KraftDoc class provides a document object that can be used in conjunction with the classes KangeApp and KangeView
  ...
  * is created by the KangeApp instance and contains the document structure with the according methods for manipulation of the document
  * data by KangeView objects. Also, KraftDoc contains the methods for serialization of the document data from and to files.
  *
...
class KraftDoc : public QObject
{
  ...
  public:
    ...
    void addView(KangeView *view);
    /** removes a view from the list of currently connected views */
    void removeView(KangeView *view);
  ...
  public slots:
     ...
     */
    void slotUpdateAllViews( KangeView *sender );
