...
/**	KraftDoc provides a document object for a document-view model.
  *
  * The KraftDoc class provides a document object that can be used in
  * conjunction with the classes KraftApp and KraftView to create a
  * document-view model for standard KDE applications based on
  * KApplication and KMainWindow. Thereby, the document object is
  * created by the KraftApp instance and contains the document
  * structure with the according methods for manipulation of the
  * document data by KraftView objects. Also, KraftDoc contains the
