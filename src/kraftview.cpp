...
void KraftView::setupFooter()
{
  ...
  m_footerEdit->ui()->mTaxCombo->insertItem( NO_TAX,   DefaultProvider::self()->icon("kraft_notax"), i18n( "Display no tax at all" ));
  m_footerEdit->ui()->mTaxCombo->insertItem( RED_TAX,  DefaultProvider::self()->icon("kraft_redtax"), i18n( "Calculate reduced tax for all items" ));
  m_footerEdit->ui()->mTaxCombo->insertItem( FULL_TAX, DefaultProvider::self()->icon("kraft_fulltax"), i18n( "Calculate full tax for all items" ));
